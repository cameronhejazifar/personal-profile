...
.toggle input + div div span:before, .toggle input + div div span:after {
  ...
  transition: transform 500ms ease, border-radius 300ms ease, background 400ms ease;
}
...
.toggle input + div svg {
  ...
  -webkit-backface-visibility: hidden;
  transform: scale(1);
  transition: stroke-dashoffset 500ms ease, stroke-dasharray 600ms ease, transform 500ms ease, stroke 400ms ease;
}
